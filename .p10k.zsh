# Generated by Powerlevel10k configuration wizard on 2022-06-06 at 11:29 JST.
...
# disconnected, full frame, dark-ornaments, sparse, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${P9K_AWS_PROFILE//\%/%%}:$(ls-prof -c | cut -d, -f3)'
